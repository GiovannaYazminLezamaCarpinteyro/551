	 ...
	 // private var fuego_new: fuego = new fuego;
	  ...
	  static var puntos: Number=0;
		...
		public function setup() {
			...
			puntos_box_new.x=80, puntos_box_new.y=130;
			
			addChild(piso_new);
			piso_new.x=1, piso_new.y=90;
			
			//addChild(fuego_new);
			//fuego_new.x=220,fuego_new.y=95;
			
			addChild(hulk_new);
			hulk_new.x=1, hulk_new.y=65;
			
			addChild(thor_new);
			thor_new.x=200, thor_new.y=340;
